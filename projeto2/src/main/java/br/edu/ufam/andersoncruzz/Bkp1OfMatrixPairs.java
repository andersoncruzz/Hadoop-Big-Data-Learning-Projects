 ...
 * @author Jimmy Lin
 */
public class Bkp1OfMatrixPairs extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(Bkp1OfMatrixPairs.class);
  ...
  public int run(String[] argv) throws Exception {
    ...
    LOG.info("Tool: " + Bkp1OfMatrixPairs.class.getSimpleName());
    ...
    job.setJobName(Bkp1OfMatrixPairs.class.getSimpleName());
    job.setJarByClass(Bkp1OfMatrixPairs.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Bkp1OfMatrixPairs(), args);
  }
}
