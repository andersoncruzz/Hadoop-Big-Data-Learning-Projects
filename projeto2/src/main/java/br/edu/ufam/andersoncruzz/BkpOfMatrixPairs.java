 ...
 * @author Jimmy Lin
 */
public class BkpOfMatrixPairs extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(BkpOfMatrixPairs.class);
  ...
  public int run(String[] argv) throws Exception {
    ...
    LOG.info("Tool: " + BkpOfMatrixPairs.class.getSimpleName());
    ...
    job.setJobName(BkpOfMatrixPairs.class.getSimpleName());
    job.setJarByClass(BkpOfMatrixPairs.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new BkpOfMatrixPairs(), args);
  }
}
