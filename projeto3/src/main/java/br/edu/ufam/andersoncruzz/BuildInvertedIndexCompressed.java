...
public class BuildInvertedIndexCompressed extends Configured implements Tool {
  ...
  private static class MyReducer extends
      Reducer<Text, ArrayListWritable<PairOfInts>, Text, PairOfWritables<VIntWritable, ArrayListWritable<PairOfWritables<VIntWritable, VIntWritable>>>> {
    ...
    public void reduce(Text key, Iterable<ArrayListWritable<PairOfInts>> values, Context context)
      ...
      ArrayListWritable<PairOfWritables<VIntWritable, VIntWritable>> postingsFinal = new ArrayListWritable<PairOfWritables<VIntWritable, VIntWritable>>();
      ...
      for (PairOfInts p: postings){
    	  ...
    	  PairOfWritables<VIntWritable, VIntWritable> pairVint = new PairOfWritables<VIntWritable, VIntWritable>();
