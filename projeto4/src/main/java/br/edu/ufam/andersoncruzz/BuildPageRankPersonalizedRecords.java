 ...
 */
public class BuildPageRankPersonalizedRecords extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(BuildPageRankPersonalizedRecords.class);
  ...
  private static class MyMapper extends Mapper<LongWritable, Text, IntWritable, PageRankNode> {
    ...
    public void map(LongWritable key, Text t, Context context) throws IOException,
      ...
      if(arr[0].equals(source)) {
         // node.setPageRank((float) StrictMath.log(Float.POSITIVE_INFINITY));     
  ...
  public BuildPageRankPersonalizedRecords() {}
  ...
  public int run(String[] args) throws Exception {
    ...
    String source = cmdline.getOptionValue(SOURCE);
    int n = Integer.parseInt(cmdline.getOptionValue(NUM_NODES));

    LOG.info("Tool name: " + BuildPageRankPersonalizedRecords.class.getSimpleName());
    ...
    job.setJobName(BuildPageRankPersonalizedRecords.class.getSimpleName() + ":" + inputPath);
    job.setJarByClass(BuildPageRankPersonalizedRecords.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new BuildPageRankPersonalizedRecords(), args);
  }
}
