...
public class LookupPostings {
  ...
  public static void main(String[] args) throws IOException {
    ...
    lookupTerm("you", reader, collectionPath, fs);
    lookupTerm("the", reader, collectionPath, fs);
    lookupTerm("yourself", reader, collectionPath, fs);
    lookupTerm("my", reader, collectionPath, fs);
